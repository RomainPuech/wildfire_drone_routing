...
OUTPUT_DIR = os.path.join(BASE_DIR, "../../../California2019Dataset_BurnProb_LargeFires")
...
def main():
    print("=" * 80)
    print("California 2019 Wildfire Dataset Creation (Burn Probability Map - FSim, Large Fires Only, >= 100 acres)")
    print("=" * 80)
    ...
    # Get all CA 2019 fires with valid dates and FIRE_SIZE >= 100 acres (large fires)
    cursor.execute("""
    ...
    config_path = os.path.join(OUTPUT_DIR, "config_california_2019_burn_prob_large_fires.json")
    ...
    summary = {
        'dataset_name': 'California2019_BurnProb_LargeFires',
