...
OUTPUT_DIR = os.path.join(BASE_DIR, "../../../California2019Dataset_IgnitionProb")
...
def main():
    print("=" * 80)
    print("California 2019 Wildfire Dataset Creation (Ignition Probability Map)")
    print("=" * 80)
    ...
    config_path = os.path.join(OUTPUT_DIR, "config_california_2019_ignition_prob.json")
    ...
    summary = {
        'dataset_name': 'California2019_IgnitionProb',
