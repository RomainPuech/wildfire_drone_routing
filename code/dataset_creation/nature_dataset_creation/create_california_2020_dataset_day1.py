...
OUTPUT_DIR = os.path.join(BASE_DIR, "../../../California2020Dataset_Day1")
...
def main():
    print("=" * 80)
    print("California 2020 Wildfire Dataset Creation (Day 1 Forecast)")
    print("=" * 80)
    ...
    config_path = os.path.join(OUTPUT_DIR, "config_california_2020_day1.json")
    ...
    summary = {
        'dataset_name': 'California2020_Day1',
