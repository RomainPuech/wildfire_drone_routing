...
OUTPUT_DIR = os.path.join(BASE_DIR, "../../../California2020Dataset_BurnProb_LargeFires")
...
def main():
    print("=" * 80)
    print("California 2020 Wildfire Dataset Creation (Burn Probability Map - FSim, Large Fires Only, >= 100 acres)")
    print("=" * 80)
    ...
    config_path = os.path.join(OUTPUT_DIR, "config_california_2020_burn_prob_large_fires.json")
    ...
    summary = {
        'dataset_name': 'California2020_BurnProb_LargeFires',
