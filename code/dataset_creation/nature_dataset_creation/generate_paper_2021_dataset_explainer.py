...
OUT_DIR = Path(os.environ.get("FIG_OUT_DIR", str(REPORT_DIR / "paper_2021_dataset_creation_explainer")))
# Output extension for the paper panels (fig01-04); set FIG_EXT=pdf for vector export.
_EXT = os.environ.get("FIG_EXT", "png")
_DPI = int(os.environ.get("FIG_DPI", "150"))
...
def main():
    ...
    plot_pyrologix_valid_region(
        pyrologix,
        mask_step1,
        OUT_DIR / f"fig01_pyrologix_california_boundary.{_EXT}",
    ...
    plot_pyrologix_valid_region(
        pyrologix,
        mask_step2,
        OUT_DIR / f"fig02_pyrologix_exclude_urban.{_EXT}",
    ...
    plot_pyrologix_valid_region(
        pyrologix,
        mask_step3,
        OUT_DIR / f"fig03_pyrologix_exclude_always_unburnable.{_EXT}",
    ...
    plot_pyrologix_valid_region(
        pyrologix,
        mask_step4,
        OUT_DIR / f"fig04_pyrologix_components_ge_9km2.{_EXT}",
        fire_layers=all_fire_layers,
        legend_handles=legend_full,
        legend_fontsize=_fig2_legend_fontsize,
        show_colorbar=False,
