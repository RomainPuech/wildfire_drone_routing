...
class ClusteredDroneStrategyWrapper(DroneRoutingStrategy):
    def __init__(self, StrategyClass, charging_stations, drone_battery, drones_per_cluster, timesteps, half_extent, total_ground_sensors, SensorStrategyClass, custom_init_params):
        ...
        sensor_strategy = SensorStrategyClass(auto_global, custom_init_params)
        ground_sensors, _ = sensor_strategy.get_locations()
