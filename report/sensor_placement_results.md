# Sensor Placement Results — WFPI vs Pyrologix

Budget-optimized sensor placement on the California 2020 grid (261×161 operational cells) under two risk maps: **WFPI (mean)** and **Pyrologix ignition probability**. Same costs: sensor 100k, station 150k, drone 50k. Gurobi time limit: 600 s (10 min).
...
|---|-------------|-----------|
| **Ground sensors** | 0 | **15** |
| **Charging stations** | 66 | **58** |
| **Drones** | 202 | **196** |
| **MIP gap** | 0.28% | **0.41%** (time limit) |
| **Placement map** | [benchmark_fire_map_budget.png](benchmark_fire_map_budget.png) | [benchmark_fire_map_pyrologix_20M.png](benchmark_fire_map_pyrologix_20M.png) |

### 100M budget

| | WFPI (mean) | Pyrologix |
|---|-------------|-----------|
| **Ground sensors** | 188 | **175** |
| **Charging stations** | 86 | **68** |
| **Drones** | 1366 | **1446** |
| **MIP gap** | 0.01% | **0.01%** (time limit) |
| **Placement map** | [benchmark_fire_map_budget_100M.png](benchmark_fire_map_budget_100M.png) | [benchmark_fire_map_pyrologix_100M.png](benchmark_fire_map_pyrologix_100M.png) |

### 500M budget

| | WFPI (mean) | Pyrologix |
|---|-------------|-----------|
| **Ground sensors** | 1832 | **30** |
| **Charging stations** | 265 | **237** |
| **Drones** | 2412 | **9130** |
| **MIP gap** | 0.0% | **0.0%** (optimal) |
| **Placement map** | [benchmark_fire_map_budget_500M.png](benchmark_fire_map_budget_500M.png) | [benchmark_fire_map_pyrologix_500M.png](benchmark_fire_map_pyrologix_500M.png) |
...
**Regenerate all placement figures (WFPI + Pyrologix):**
```bash
python report/generate_benchmark_report_figures.py
```

Requires: WFPI rescaled map and, for Pyrologix figures, `California2020Dataset/static_risk_pyrologix_resampled.npy` and the three Pyrologix sensor caches.
