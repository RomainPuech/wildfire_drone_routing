...
#SBATCH --job-name=wf_greedy_uniform_500M_ws
...
BUDGET=500
TIME_LIMIT=43200
WARM_START="California2021Dataset/logs/sensor_alloc_GaussianBudget100M_StationMaxGreedyUniform_261x161_mean.json"

python-jl test_budget_placement_station_max_greedy_uniform_2021.py \
  --budget "${BUDGET}" --time-limit "${TIME_LIMIT}" --warm-start "${WARM_START}"
