...
#SBATCH --job-name=wf_500M_fnature_ml
...
echo "500M final-nature | Task ${SLURM_ARRAY_TASK_ID}: strategy=${STRAT}"
...
echo "500M final-nature task ${SLURM_ARRAY_TASK_ID} (${STRAT}) done."
