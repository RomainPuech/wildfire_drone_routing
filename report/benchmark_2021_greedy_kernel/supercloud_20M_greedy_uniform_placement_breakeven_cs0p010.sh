#!/bin/bash
# 20M greedy-uniform placement, cost_sensor=0.010M (1.0× analytic center 0.01M).
#
#SBATCH --job-name=wf_bb_cs010
#SBATCH --cpus-per-task=32
#SBATCH --time=14:00:00
#SBATCH --output=logs/breakeven_20M_cs0p010_%x-%j.out
#SBATCH --error=logs/breakeven_20M_cs0p010_%x-%j.err
...
python-jl test_budget_placement_station_max_greedy_uniform_2021.py \
  ...
  --cost-sensor 0.01 \
  --warm-start "${WARM}" \
  --output-tag breakeven_cs0p010

echo "breakeven placement cs0.010M done."
