#!/bin/bash
# 20M greedy-uniform placement, cost_sensor=0.009M (0.9× analytic center 0.01M).
#
#SBATCH --job-name=wf_bb_cs009
#SBATCH --cpus-per-task=32
#SBATCH --time=14:00:00
#SBATCH --output=logs/breakeven_20M_cs0p009_%x-%j.out
#SBATCH --error=logs/breakeven_20M_cs0p009_%x-%j.err
...
python-jl test_budget_placement_station_max_greedy_uniform_2021.py \
  ...
  --cost-sensor 0.009 \
  --warm-start "${WARM}" \
  --output-tag breakeven_cs0p009

echo "breakeven placement cs0.009M done."
