#!/bin/bash
# 50M greedy-uniform placement, cost_sensor=0.014M.
#
#SBATCH --job-name=wf_bb50_cs014
#SBATCH --cpus-per-task=32
#SBATCH --time=14:00:00
#SBATCH --output=logs/breakeven_50M_cs0p014_%x-%j.out
#SBATCH --error=logs/breakeven_50M_cs0p014_%x-%j.err
...
python-jl test_budget_placement_station_max_greedy_uniform_2021.py \
  ...
  --cost-sensor 0.014 \
  --warm-start "${WARM}" \
  --output-tag breakeven_50M_cs0p014

echo "breakeven 50M placement cs0.014M done."
