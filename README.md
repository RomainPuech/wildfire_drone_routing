...
scenario = load_scenario("WideDataset/0111_03612/Satellite_Images_Mask/0111_00013", extension = ".jpg") # example scenario

results = run_benchmark_scenario(
    scenario=scenario,
    sensor_placement_strategy=RandomSensorPlacementStrategy,
    drone_routing_strategy=RandomDroneRoutingStrategy,
...
results = run_benchmark_scenarii_sequential(
    input_dir="./WideDataset/0111_03612/scenarii", # the scenarii folder is generated by the preprocessing
    sensor_placement_strategy=RandomSensorPlacementStrategy,
    drone_routing_strategy=RandomDroneRoutingStrategy,
    custom_initialization_parameters_function=lambda x: {...}, # specify the burn maps, see all_experiments_parallel.py for an example
...
create_scenario_video(
    ...
    drone_locations_history=drone_history, # as output by `run_benchmark_scenario` with `return_history=True`
