...
def custom_initialization_parameters_function(input_dir:str):
    ...
    return {"burnmap_filename": f"{'/'.join(input_dir.strip('/').split('/')[:-1])}/static_risk.npy", "reevaluation_step": 2, "optimization_horizon":2, "regularization_param": 1}


# def custom_initialization_parameters_function2(input_dir:str):
#     print(f"input_dir: {input_dir}")
#     return {"burnmap_filename": f"WideDataset/0004_01191/static_risk.npy", "reevaluation_step": 5, "optimization_horizon":10, "regularization_param": 1}


dataset_folder_name = "WideDataset/"
time_start = time.time()
#run_benchmark_scenarii_sequential_precompute("WideDataset/0004_01191/Satellite_Images_Mask/", sensor_strategy, drone_strategy, custom_initialization_parameters_function, return_no_custom_parameters, file_format="jpg", simulation_parameters=simulation_parameters)

benchmark_on_sim2real_dataset_precompute(dataset_folder_name, sensor_strategy, drone_strategy, custom_initialization_parameters_function, return_no_custom_parameters, max_n_scenarii=None, max_n_layouts=10, simulation_parameters = simulation_parameters, file_format="jpg", config_file="config_s2r.json")
