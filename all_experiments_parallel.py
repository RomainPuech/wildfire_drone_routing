...
from wrappers import RandomSensorPlacementStrategyLogged, SensorPlacementMaxCoverageGaussianTimeLogged, DroneRoutingUniformCoverageResetStaticLogged, DroneRoutingMaxCoverageResetStaticLogged, RandomDroneRoutingStrategyLogged
...
def run_one_drone_strategy(sensor_strategy, drone_strategy, custom_initialization_parameters_function, experiment_name=""):
    strategy_name = sensor_strategy.strategy_name + "_" + drone_strategy
    ...
    benchmark_on_sim2real_dataset_precompute_parallel(
        ...
        # selected_layout_names= ["0262_03319","0264_02426","0265_02487"],
        file_format="npy",
    ...
    combine_all_benchmark_results("/home/gridsan/jye/WFDroneBench_local/WideDataset", strategy_name = strategy_name, experiment_name = experiment_name)   
...
def run_all_drone_strategies(sensor_strategy, ss_prefix, bm_prefix):
    ...
    run_one_drone_strategy(sensor_strategy, "DroneRoutingMaxCoverageResetStaticLogged", init_func, f"{ss_prefix}MCg{bm_prefix}_parallel")
