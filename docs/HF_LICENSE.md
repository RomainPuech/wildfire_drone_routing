...
- Include `hf_release/NOTICE` (or equivalent attribution text) in every published archive.
...
See also `NOTICE` at the repository root and `hf_release/NOTICE` for release packaging.
